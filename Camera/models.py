...
class Client(AbstractBaseUser, PermissionsMixin):
    ...
    ph_no=models.IntegerField(null=True, blank=False)
...
class Record(models.Model):
    ...
    person_selling_phone=models.IntegerField(null=True, blank=False)
    ...
    phone_sold_date=models.DateTimeField(default=timezone.now)
